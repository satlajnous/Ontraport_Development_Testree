...
public class CreateRule_TC0055 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_SMSReceivedFromContact()
			throws Exception {
		...
		String[] placeHolders = { "Select Trigger...", "Select Number"};
		String[] selectOptions = { "SMS Received from contact", "Any Number"};
		...
		boolean b3= ruleEdit.verifyWhenThisHappensText("SMS Received from contact on ");
		boolean b4 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select Number", "Any Number");
