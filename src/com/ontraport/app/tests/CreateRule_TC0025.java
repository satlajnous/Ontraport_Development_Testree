...
public class CreateRule_TC0025 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_ACertainFieldIsUpdated_Dropdown()
			throws Exception {
		...
		String[] selectOptions = { "A Certain field is updated", "SelDropdown"};
		...
		boolean b3 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select Field...", "SelDropdown");
