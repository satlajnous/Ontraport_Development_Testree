...
public class LeadScoring_TC0485 extends AbstractTest {
	
	@Test
	public void testLeadScoring_TC0485_SMSDoesNotContainsEmailAddress() throws Exception {
		...
		String[] selectOptions = {"SMS does not contain an E-mail address"};
		...
		boolean b1 = leadScoringEditPgObj.contactScoringConditionText("SMS does not contain an E-mail address");
