...
public class CreateRule_TC0046 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_SubscriptionToProductIs_Cancelled()
			throws Exception {
		...
		String[] selectOptions = { "Subscription to product is Charged, Cancelled, or Completed", "Any Subscription Product", "Cancelled" };
		...
		boolean b6= ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select...","Cancelled");
