...
public class CreateRule_TC0029 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_WhenContactIsRemovedToSeq_Step()
			throws Exception {
		...
		String[] selectOptions = { "When Contact is removed from Sequence", "Any Sequence" };
