...
public class CreateRule_TC0031 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_SubscriptionToSeqPaused_Step()
			throws Exception {
		...
		String[] selectOptions = { "Subscription to Sequence is Paused", "Any Sequence" };
		...
		boolean b3 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select Sequence","Any Sequence");
