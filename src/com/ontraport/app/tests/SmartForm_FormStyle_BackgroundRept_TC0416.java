...
public class SmartForm_FormStyle_BackgroundRept_TC0416 extends AbstractTest {
	String smartFormName = "SForm" + Calendar.getInstance().getTimeInMillis();
	String sectionName = "label style";
	String fieldName = "Background Repeat";
	String giveFontName = "repeat";

	
	@Test
	public void SmartForm_FormStyle_BackgroundRept_TC0416 () throws Exception{
