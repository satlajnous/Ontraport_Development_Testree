...
public class SmartForm_BorderStyle_TC0358 extends AbstractTest {
	String smartFormName = "SForm" + Calendar.getInstance().getTimeInMillis();
	String giveFontName = "Arial Black";

	
	@Test
	public void testSmartForm_BorderStyle_TC0358 () throws Exception{
		...
		//Fill text box field
		smartFormEdit.setSelectInFieldSettingsBasedOnLabel("Border Style", "dotted");
		...
		boolean b = smartFormEdit.verifySelectedOptionInFieldSettingsBasedOnLabel("Border Style", "dotted");
