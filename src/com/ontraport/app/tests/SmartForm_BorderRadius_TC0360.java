...
public class SmartForm_BorderRadius_TC0360 extends AbstractTest {
	...
	public void testSmartForm_BorderStyle_TC0358 () throws Exception{
		...
		//Fill text box field
		smartFormEdit.setSelectInFieldSettingsBasedOnLabel("Border Radius", "12px");
		...
		boolean b = smartFormEdit.verifySelectedOptionInFieldSettingsBasedOnLabel("Border Radius", "12px");
