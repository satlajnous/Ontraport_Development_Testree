...
public class CreateGateway_TC0592 extends AbstractTest {
	...
	public void testCreateQuickBooks_QBMSGateway () throws Exception{
	     ...
	     gatewayList=createGateWayTest(gateway, "QuickBooks (QBMS)", detailTitle, detailValues);
		...
		boolean b3 = gatewayEdit.verifyTextInput("ConnectionTicket", "test1");
		boolean b4 = gatewayEdit.verifyTextInput("AppLogin", "test2");
		boolean b5 = gatewayEdit.verifyTextInput("AppID", "test3");
