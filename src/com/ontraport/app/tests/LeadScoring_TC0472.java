...
public class LeadScoring_TC0472 extends AbstractTest{
	
	@Test
	public void testLeadScoring_HasVisitedWebsiteCertainNoTimes() throws Exception {
		...
		String[] placeHolders = {"Select Condition", "Select Website", "Select..."};
		String[] selectOptions = {"Has visited a website a certain number of times", "Any Website", "Equal To"};
		...
		boolean b = leadScoringEditPgObj.verifyTheValueInDropDownBasedOnPlaceHolder ("Select Website", "Any Website");
