...
public class SmartForm_Background_BorderStyle_TC0449 extends AbstractTest {
	String smartFormName = "SForm" + Calendar.getInstance().getTimeInMillis();
	String sectionName = "Background";
	String fieldName = "Border Style";
	String fieldvalue = "groove";

	
	@Test
	public void SmartForm_Background_BorderStyle_TC0449() throws Exception{
