...
public class CreateRule_TC0021 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_ACertainFieldIsUpdated_LongText()
			throws Exception {
		...
		String[] selectOptions = { "A Certain field is updated", "SelLongText"};
		...
		boolean b3 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select Field...", "SelLongText");
