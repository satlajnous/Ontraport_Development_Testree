...
public class CreateRule_TC0024 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_ACertainFieldIsUpdated_State()
			throws Exception {
		...
		String[] selectOptions = { "A Certain field is updated", "SelState"};
		...
		boolean b3 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select Field...", "SelState");
