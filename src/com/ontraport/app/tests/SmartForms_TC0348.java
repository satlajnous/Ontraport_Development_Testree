...
public class SmartForms_TC0348 extends AbstractTest {
	String smartFormName = "SForm" + Calendar.getInstance().getTimeInMillis();
	String buttonText="TEST";
	
	@Test
	public void testSmartForms_ButtonText () throws Exception{
		...
		//Fill text box field
		smartFormEdit = smartFormEdit.setTextInFieldSettingsBasedOnLabel("Button Text", buttonText);
		Thread.sleep(1000);
		smartFormEdit.clickSaveButton();
		smartFormEdit = navigateToContactsAndClickSmartForms (smartFormName);
		smartFormEdit = smartFormEdit.clickSubmitButton();
		//Verification on text box field
		boolean b = smartFormEdit.verifyTextInFieldSettingsBasedOnLabel("Button Text", buttonText);
