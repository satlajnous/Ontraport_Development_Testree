...
public class CreateGateway_TC0590 extends AbstractTest {
	...
	public void testCreatePayLeapGateway () throws Exception{
	     ...
	     gatewayList= createGateWayTest(gateway, "PayLeap", detailTitle, detailValues);
		...
		boolean b3 = gatewayEdit.verifyTextInput("UserName", "test1");
		boolean b4 = gatewayEdit.verifyTextInput("Password", "test2");
