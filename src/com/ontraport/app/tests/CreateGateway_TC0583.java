...
public class CreateGateway_TC0583 extends AbstractTest {
	...
	public void testCreateAuthorizeNetGateway() throws Exception {
		...
		gatewayList = createGateWayTest(gateway, "Authorize.net", detailTitle,
				detailValues);
		...
		boolean b3 = gatewayEdit.verifyTextInput("x_login", "test1");
		boolean b4 = gatewayEdit.verifyTextInput("x_tran_key", "test2");
