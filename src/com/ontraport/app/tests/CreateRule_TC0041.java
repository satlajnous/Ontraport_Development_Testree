...
public class CreateRule_TC0041 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_GetsARefundOnAProduct()
			throws Exception {
		...
		String[] selectOptions = { "Gets a refund on a Product", "Any Product" };
		...
		boolean b3= ruleEdit.verifyWhenThisHappensText("Gets a refund on ");
		boolean b4 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select Product","Any Product");
