...
public class CreateRule_TC0037 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_OpensEmail()
			throws Exception {
		...
		String[] selectOptions = { "Opens E-mail", "Any E-Mail" };
		...
		boolean b3= ruleEdit.verifyWhenThisHappensText("Opens ");
		boolean b4 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select E-Mail","Any E-Mail");
