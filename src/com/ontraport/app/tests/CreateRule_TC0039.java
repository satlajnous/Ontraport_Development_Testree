...
public class CreateRule_TC0039 extends AbstractTest {
	...
	public void testCreateRule_SendsYouAnEmail()
		...
		String[] selectOptions = { "Sends you an E-mail" };
		...
		boolean b3 = ruleEdit.verifyWhenThisHappensText("Sends you an E-mail");
