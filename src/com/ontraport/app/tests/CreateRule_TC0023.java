...
public class CreateRule_TC0023 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_ACertainFieldIsUpdated_Price()
			throws Exception {
		...
		String[] selectOptions = { "A Certain field is updated", "SelPrice"};
		...
		boolean b3 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select Field...", "SelPrice");
