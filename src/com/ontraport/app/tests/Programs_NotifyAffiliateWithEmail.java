...
public class Programs_NotifyAffiliateWithEmail extends AbstractTest{
	...
	@Test
	public void testTC0657_Create_Programs_NotifyAffiliateWithEmail() throws Exception {
		...
		String newNotifyEmail= affProgEdit.getTextNotifyWithEmail();
		Assert.assertEquals(emailID, newNotifyEmail);
}
