...
public class SmartForm_BorderSize_TC0359 extends AbstractTest {
	...
	public void testSmartForm_BorderStyle_TC0358 () throws Exception{
		...
		//Fill text box field
		smartFormEdit.setSelectInFieldSettingsBasedOnLabel("Border Size", "9px");
		...
		boolean b = smartFormEdit.verifySelectedOptionInFieldSettingsBasedOnLabel("Border Size", "9px");
