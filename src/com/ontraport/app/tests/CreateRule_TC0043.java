...
public class CreateRule_TC0043 extends AbstractTest {
	...
	public void testCreateRule_VisitsAPURL()
		...
		String[] placeHolders = { "Select Trigger...", "Select PURL" };
		String[] selectOptions = { "Visits a PURL", "Any PURL" };
		...
		boolean b4 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select PURL","Any PURL");
