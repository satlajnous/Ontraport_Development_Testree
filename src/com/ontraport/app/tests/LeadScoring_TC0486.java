...
public class LeadScoring_TC0486 extends AbstractTest {
	
	@Test
	public void testLeadScoring_TC0486_SMSContainText() throws Exception {
		...
		String[] selectOptions = {"SMS Contains Text"};
		...
		//boolean b1 = leadScoringEditPgObj.verifyTheValueInDropDownBasedOnPlaceHolder ("Select Condition", "SMS Contains Text");	
