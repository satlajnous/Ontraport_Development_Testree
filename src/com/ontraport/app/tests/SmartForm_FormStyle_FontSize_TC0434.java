...
public class SmartForm_FormStyle_FontSize_TC0434 extends AbstractTest {
	String smartFormName = "SForm" + Calendar.getInstance().getTimeInMillis();
	String sectionName = "Input Text Style";
	String fieldName = "Font Size";
	String giveFontName = "12";

	
	@Test
	public void SmartForm_FormStyle_FontSize_TC0434 () throws Exception{
