...
public class CreateGateway_TC0586 extends AbstractTest {
	...
	public void testCreateeWAYTokenGateway() throws Exception {
		String[] detailTitle = { "ewayCustomerID", "ewayRefundPassword",
				"ewayUsername", "ewayPassword" };
		String[] detailValues = { "test1", "test2", "test3", "test4" };
		gatewayList = createGateWayTest(gateway, "eWAY Token", detailTitle,
				detailValues);
		...
		boolean b5 = gatewayEdit.verifyTextInput("ewayUsername", "test3");
		boolean b6 = gatewayEdit.verifyTextInput("ewayPassword", "test4");
