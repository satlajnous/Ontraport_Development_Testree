...
public class CreateGateway_TC0594 extends AbstractTest {
	...
	public void testCreateUSAePayTokenGateway() throws Exception {
		...
		gatewayList = createGateWayTest(gateway, "USAePay Token", detailTitle,
				detailValues);
		...
		boolean b3 = gatewayEdit.verifyTextInput("UMkey", "test1");
		boolean b4 = gatewayEdit.verifyTextInput("UMpin", "test2");
