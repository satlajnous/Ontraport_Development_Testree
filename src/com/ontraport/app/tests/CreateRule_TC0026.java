...
public class CreateRule_TC0026 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_ACertainFieldIsUpdated_Image()
			throws Exception {
		...
		String[] selectOptions = { "A Certain field is updated", "SelImage"};
		...
		boolean b3 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select Field...", "SelImage");
