...
public class CreateRule_TC0020 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_ACertainFieldIsUpdated_Date()
			throws Exception {
		...
		String[] selectOptions = { "A Certain field is updated", "SelDate"};
		...
		boolean b3 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select Field...", "SelDate");
