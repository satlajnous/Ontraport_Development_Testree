...
public class CreateGateway_TC0584 extends AbstractTest {
	...
	public void testCreateElavonGateway() throws Exception {
		...
		gatewayList = createGateWayTest(gateway, "Elavon", detailTitle,
				detailValues);
		...
		boolean b3 = gatewayEdit.verifyTextInput("ssl_merchant_id", "test1");
		boolean b4 = gatewayEdit.verifyTextInput("ssl_user_id", "test2");
		boolean b5 = gatewayEdit.verifyTextInput("ssl_pin", "test3");
