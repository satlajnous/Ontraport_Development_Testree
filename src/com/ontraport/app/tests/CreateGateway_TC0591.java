...
public class CreateGateway_TC0591 extends AbstractTest {
	...
	public void testCreatePayPalGateway () throws Exception{
	     ...
	     gatewayList= createGateWayTest(gateway, "PayPal", detailTitle, detailValues);
		...
		boolean b3 = gatewayEdit.verifyTextInput("email", "test1");
