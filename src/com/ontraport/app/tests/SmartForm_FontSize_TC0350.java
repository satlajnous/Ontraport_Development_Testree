...
public class SmartForm_FontSize_TC0350 extends AbstractTest {
	String smartFormName = "SForm" + Calendar.getInstance().getTimeInMillis();
	String giveFontName = "Arial Black";

	
	@Test
	public void testSmartForm_FontSize_TC0350 () throws Exception{
		...
		//Fill text box field
		smartFormEdit.setSelectInFieldSettingsBasedOnLabel("Font Size", "12");
		...
		boolean b = smartFormEdit.verifySelectedOptionInFieldSettingsBasedOnLabel("Font Size", "12");
