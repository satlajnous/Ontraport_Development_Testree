...
public class CreateRule_TC0022 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_ACertainFieldIsUpdated_Numeric()
			throws Exception {
		...
		String[] selectOptions = { "A Certain field is updated", "SelNumeric"};
		...
		boolean b3 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select Field...", "SelNumeric");
