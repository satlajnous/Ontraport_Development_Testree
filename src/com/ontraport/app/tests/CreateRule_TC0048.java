...
public class CreateRule_TC0048 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_CreditCardIs_Charged()
			throws Exception {
		...
		String[] selectOptions = { "Credit card is charged or declined", "Charged"};
		...
		boolean b4 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select...","Charged");
