...
public class LeadScoring_TC0327 extends AbstractTest {
	String seqName = "DateSeq" + Calendar.getInstance().getTimeInMillis();
	@Test
	public void testLeadScoring_ContactSubscribedToSequence_Date()throws Exception {
		...
		String[] selectOptions = {"If Contact is subscribed to Sequence", seqName };
