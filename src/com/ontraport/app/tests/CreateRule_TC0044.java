...
public class CreateRule_TC0044 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_IsSubscribedToSubscriptionProduct()
			throws Exception {
		...
		String[] placeHolders = { "Select Trigger...", "Select Subscription Product" };
		String[] selectOptions = { "Is subscribed to subscription product", "Any Subscription Product" };
		...
		boolean b3= ruleEdit.verifyWhenThisHappensText("Is subscribed to ");
