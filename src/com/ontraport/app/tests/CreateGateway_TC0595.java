...
public class CreateGateway_TC0595 extends AbstractTest {
	...
	public void testCreatePayPalPaymentsProGateway () throws Exception{
	     ...
	     gatewayList=createGateWayTest(gateway, "PayPal Payments Pro", detailTitle, detailValues);
		...
		boolean b4 = gatewayEdit.verifyTextInput("PWD", "test2");
		boolean b5 = gatewayEdit.verifyTextInput("SIGNATURE", "test3");
