...
public class LeadScoring_TC0341 extends AbstractTest{
	

	
	
	@Test
	public void testLeadScoring_AfieldMeetsAgivenCriteriaDropdown() throws Exception {
		...
		String[] selectOptions = {"Field is this value", "SelDropdown", "Equal To","SelText"};
		...
		boolean b = leadScoringEditPgObj.verifyTheValueInDropDownBasedOnPlaceHolder ("Select Field...", "SelDropdown");
		boolean b1 = leadScoringEditPgObj.verifyTheValueInDropDownBasedOnPlaceHolder ("Select Condition...", "Equal To");	
		boolean b2 = leadScoringEditPgObj.verifyTheValueInDropDownBasedOnPlaceHolder("Select...", "SelText");
