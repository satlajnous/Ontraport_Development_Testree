...
public class CreateRule_TC0050 extends AbstractTest {
	...
	public void testCreateRule_WhenContactIsAddedToTag()
		...
		String[] selectOptions = { "When Contact is added to Tag", tagName};
		...
		boolean b3= ruleEdit.verifyWhenThisHappensText("When Contact is added to Tag:");
