...
public class Programs_ShowAffiliateInfoOnDeclinedCharges extends AbstractTest{
	...
	String checkboxAffiliateOnDeclinedTransaction= "YES";
	String checkboxAffiliatePurchaseHistory="NO";
	String emailID="test@test.com";
	@Test
	public void testTC0655_Create_Programs_ShowAffiliateInfoOnDeclinedCharges() throws Exception {
		...
		String newAffOnDeclined= affProgEdit.getTextAffiliateInfoOnDeclinedCharges();
		Assert.assertEquals("Yes", newAffOnDeclined);
}
