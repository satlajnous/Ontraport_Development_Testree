...
public class CreateGateway_TC0588 extends AbstractTest {
	...
	public void testCreatePayflowProGateway () throws Exception{
	     ...
	     gatewayList=createGateWayTest(gateway, "Payflow Pro", detailTitle, detailValues);
		...
		boolean b3 = gatewayEdit.verifyTextInput("USER", "test1");
		boolean b4 = gatewayEdit.verifyTextInput("VENDOR", "test2");
		boolean b5 = gatewayEdit.verifyTextInput("PARTNER", "test3");
		boolean b6 = gatewayEdit.verifyTextInput("PWD", "test4");
		...
		Assert.assertTrue("Value in Text Field", b5);
		Assert.assertTrue("Value in Text Field", b6);
