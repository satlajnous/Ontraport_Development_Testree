...
public class CreateRule_TC0049 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_CreditCardIs_Declined()
			throws Exception {
		...
		String[] placeHolders = { "Select Trigger...", "Select..."};
		String[] selectOptions = { "Credit card is charged or declined", "Declined"};
		...
		boolean b3= ruleEdit.verifyWhenThisHappensText("Credit card is ");
		boolean b4 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select...","Declined");
