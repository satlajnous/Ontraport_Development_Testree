...
public class CreateRule_TC0036 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_ClicksTrackedLink()
			throws Exception {
		...
		String[] placeHolders = { "Select Trigger...", "Select Tracked Link" };
		String[] selectOptions = { "Clicks tracked link", "Any Tracked Link" };
		...
		boolean b3= ruleEdit.verifyWhenThisHappensText("Clicks ");
		boolean b4 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select Tracked Link","Any Tracked Link");
