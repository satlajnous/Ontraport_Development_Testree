...
public class SmartForm_FormStyle_BackgroundPos_TC0415 extends AbstractTest {
	String smartFormName = "SForm" + Calendar.getInstance().getTimeInMillis();
	String sectionName = "label style";
	String fieldName = "Background Position";
	String fieldvalue = "Right Top";

	
	@Test
	public void SmartForm_FormStyle_BackgroundPos_TC0415 () throws Exception{
		...
		smartFormEdit.setSelectInFormStyleBasedOnLabel(sectionName,fieldName, fieldvalue);      
		...
		smartFormEdit = smartFormEdit.clickFormStyle();
		boolean b = smartFormEdit.verifySelectedOptionInFormStyleBasedOnLabel(sectionName,fieldName, fieldvalue);
