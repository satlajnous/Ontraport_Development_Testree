...
public class SmartForm_Background_BorderSize_TC0451 extends AbstractTest {
	String smartFormName = "SForm" + Calendar.getInstance().getTimeInMillis();
	String sectionName = "Background";
	String fieldName = "Border Size";
	String fieldvalue = "10px";

	
	@Test
	public void SmartForm_Background_BorderSize_TC0451() throws Exception{
