...
public class LeadScoring_TC0506 extends AbstractTest{
	
	@Test
	public void testTC0506_Action_LeadScoring_BackButton() throws Exception {
		...
		contactListAll=leadScoringEditPgObj.clickBack();
