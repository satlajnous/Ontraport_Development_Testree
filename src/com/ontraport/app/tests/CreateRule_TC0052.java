...
public class CreateRule_TC0052 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_WhenContactIsAddedToFulfillmentList()
			throws Exception {
		...
		String[] placeHolders = { "Select Trigger...", "Select Fulfillment List"};
		String[] selectOptions = { "When Contact is added to Fulfillment List", "Any Fulfillment List"};
		...
		boolean b3= ruleEdit.verifyWhenThisHappensText("When Contact is added to Fulfillment List:");
		boolean b4 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select Fulfillment List", "Any Fulfillment List");
