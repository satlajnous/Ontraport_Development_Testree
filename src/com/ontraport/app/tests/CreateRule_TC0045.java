...
public class CreateRule_TC0045 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_SubscriptionToProductIs_Charged()
			throws Exception {
		...
		String[] selectOptions = { "Subscription to product is Charged, Cancelled, or Completed", "Any Subscription Product", "Charged" };
		...
		boolean b6= ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select...","Charged");
