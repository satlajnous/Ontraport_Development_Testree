...
public class CreateRule_TC0042 extends AbstractTest {
	...
	public void testCreateRule_VisitsALandingPage()
		...
		String[] placeHolders = { "Select Trigger...", "Select Landing Page" };
		String[] selectOptions = { "Visits a landing page", "Any Landing Page" };
		...
		boolean b4 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select Landing Page","Any Landing Page");
