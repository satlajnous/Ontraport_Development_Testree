...
public class CreateGateway_TC0581 extends AbstractTest {
	...
	public void testCreateDummyGateway() throws Exception {
		...
		gatewayList=createGateWayTest(gateway, "Dummy Gateway", detailTitle, detailValues);
		...
		boolean b3= gatewayEdit.verifyTextInput("nickname", "test1");
	...
	public Gateway_ListAll createGateWayTest(String gatewayName, String gatewayType,
			String[] detailTitle, String[] detailValues) throws Exception {
