...
public class CreateGateway_TC0589 extends AbstractTest {
	...
	public void testCreatePayJunctionGateway() throws Exception {
		...
		gatewayList = createGateWayTest(gateway, "PayJunction", detailTitle,
				detailValues);
		...
		boolean b3 = gatewayEdit.verifyTextInput("dc_logon", "test1");
		boolean b4 = gatewayEdit.verifyTextInput("dc_password", "test2");
