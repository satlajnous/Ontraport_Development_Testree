...
public class LeadScoring_TC0328 extends AbstractTest {
	String seqName = "StpSeq" + Calendar.getInstance().getTimeInMillis();
	@Test
	public void testLeadScoring_ContactNotSubscribedToSequence_Step()throws Exception {
		...
		String[] selectOptions = {"If Contact is not subscribed to Sequence", seqName };

		leadScoringEditPgObj = leadScoringEditPgObj.selectDropDownsBasedOnConditions(placeHolders, selectOptions);
		leadScoringEditPgObj = leadScoringEditPgObj.assignLeadScoringvalue("12");
		leadScoringEditPgObj.clickSaveButton();
		Common.waitForPage(driver, 3);
		...
		boolean b2 = leadScoringEditPgObj.verifyScoreValue("12");
