...
public class CreateRule_TC0018 extends AbstractTest {
	String ruleName = "SelRule" + Calendar.getInstance().getTimeInMillis();
	
	@Test
	public void testCreateRule_ACertainFieldIsUpdated_Text()
			throws Exception {
		...
		String[] selectOptions = { "A Certain field is updated", "First Name"};
		...
		boolean b3 = ruleEdit.verifyTheValueInDropDownBasedOnPlaceHolder("Select Field...", "First Name");
