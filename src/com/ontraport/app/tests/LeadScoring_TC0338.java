...
public class LeadScoring_TC0338 extends AbstractTest{
	

	
	
	@Test
	public void testLeadScoring_AfieldMeetsAgivencriteriaNumeric() throws Exception {
		...
		String[] selectOptions = {"Field is this value", "SelNumeric", "Equal To"};
		...
		boolean b = leadScoringEditPgObj.verifyTheValueInDropDownBasedOnPlaceHolder ("Select Field...", "SelNumeric");
		boolean b1 = leadScoringEditPgObj.verifyTheValueInDropDownBasedOnPlaceHolder ("Select Condition...", "Equal To");	
		boolean b2 = leadScoringEditPgObj.verifyValueOfTxtBoxBasedOnIndex(4, "1");
		...
		Assert.assertTrue ("Select Numeric Comparision", b);
		Assert.assertTrue ("Condition selected", b1);
		Assert.assertTrue ("Numeric Comparison", b2);
